...
function App() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      (processamentoStatus.status === "iniciando" ||
  ...
  const fetchProcessamentoStatus = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `${API_URL}/processamento/${processamentoId}/status`
      );
  ...
  const fetchProcessamentoResultado = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_URL}/processamento/${processamentoId}/resultado`
      );
  ...
  const handleUploadSimples = async (e) => {
    ...
    try {
      ...
      const fichaRes = await axios.get(
        `${API_URL}/ficha/${uploadRes.data.filename}`
      );
          ...
          <div className="status-info">
            <div className="status-item">
              ...
              <span className={`status-badge ${processamentoStatus.status}`}>
                ...
                {processamentoStatus.status === "concluido" && (
                  <FiCheckCircle />
                )}
            ...
            <div className="status-item">
              <strong>Progresso:</strong> {processamentoStatus.processados}/
              {processamentoStatus.totalArquivos} arquivos
            </div>
            <div className="status-item">
              <strong>Sucessos:</strong>{" "}
              {processamentoStatus.processados - processamentoStatus.erros}
            </div>
            <div className="status-item">
            ...
            {processamentoStatus.status === "processando" && (
              <div className="progress-bar">
                <div
                  ...
                  style={{
                    width: `${
                      (processamentoStatus.processados /
                        processamentoStatus.totalArquivos) *
                      100
                    }%`,
                  }}
                ></div>
        ...
        <div className="resultado-multiplo">
          ...
          <div className="resultado-resumo">
            <p>
              ...
              {processamentoResultado.totalArquivos}
            </p>
            <p>
              <strong>Processados com sucesso:</strong>{" "}
              {processamentoResultado.processados -
                processamentoResultado.erros}
            </p>
            <p>
              <strong>Erros:</strong> {processamentoResultado.erros}
            </p>
          </div>
          ...
          {processamentoResultado.resultados && (
            <div className="resultados-detalhados">
              ...
              {processamentoResultado.resultados.map((resultado, index) => (
                <div
                  key={index}
                  className={`resultado-item ${resultado.status}`}
                >
          ...
          {processamentoResultado.dadosConsolidados &&
            processamentoResultado.dadosConsolidados.fichaConsolidada && (
              <div className="result-container">
                <div className="result-title">
                  <h3>Ficha Técnica Consolidada</h3>
                  <p>
                    Total de projetos processados:{" "}
                    {processamentoResultado.dadosConsolidados.totalProjetos}
                  </p>
                </div>
                ...
                <div className="ficha-tecnica">
                  <div className="ficha-header">
                    ...
                    <p>
                      ...
                      {new Date(
                        processamentoResultado.dataFim
                      ).toLocaleString()}
                    </p>
                  </div>
                  ...
                  <div className="ficha-body">
                    <div className="ficha-section">
                      <h4 className="ficha-section-title">
                        Dados Consolidados
                      </h4>
                        ...
                        <div className="ficha-subsection">
                          ...
                          <div className="ficha-grid">
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.informacoesGerais.pais
                                }
                              </div>
                            </div>
                            <div className="ficha-item">
                              <div className="ficha-item-label">
                                TIPO DE PROJETO:
                              </div>
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.informacoesGerais
                                    .tipoProjeto
                                }
                              </div>
                            </div>
                            ...
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.informacoesGerais.duracao
                                }
                              </div>
                            </div>
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.informacoesGerais.objeto
                                }
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="ficha-grid">
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.localizacao.latitude
                                }
                              </div>
                            </div>
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.localizacao.longitude
                                }
                              </div>
                            </div>
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.localizacao.rio
                                }
                              </div>
                            </div>
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.localizacao.bacia
                                }
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="ficha-grid">
                            ...
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.desvio.vazaoDesvio
                                }
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="ficha-grid">
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.reservatorio
                                    .naMaximoNormalMontante
                                }
                              </div>
                            </div>
                            <div className="ficha-item">
                              <div className="ficha-item-label">
                                ÁREA NO NÍVEL MÁXIMO NORMAL:
                              </div>
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.reservatorio
                                    .areaNivelMaximoNormal
                                }
                              </div>
                            </div>
                            <div className="ficha-item">
                              <div className="ficha-item-label">
                                VOLUME NO NÍVEL MÁXIMO NORMAL:
                              </div>
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.reservatorio
                                    .volumeNivelMaximoNormal
                                }
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="ficha-grid">
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.barragemPrincipal.tipo
                                }
                              </div>
                            </div>
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.barragemPrincipal
                                    .alturaMaxima
                                }
                              </div>
                            </div>
                            ...
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.barragemPrincipal.volume
                                }
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="ficha-grid">
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.barragensComplementares
                                    .tipo
                                }
                              </div>
                            </div>
                          ...
                          <div className="ficha-grid">
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.vertedouro.tipo
                                }
                              </div>
                            </div>
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.vertedouro.numeroVaos
                                }
                              </div>
                            </div>
                            <div className="ficha-item">
                            ...
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.vertedouro.capacidade
                                }
                              </div>
                            </div>
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.vertedouro.tr
                                }
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="ficha-grid">
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.casaForcaPrincipal.tipo
                                }
                              </div>
                            </div>
                            <div className="ficha-item">
                              ...
                              <div className="ficha-item-value">
                                {
                                  processamentoResultado.dadosConsolidados
                                    .fichaConsolidada.casaForcaPrincipal
                      ...
                      {processamentoResultado.dadosConsolidados.fichaConsolidada
                        ...
                        <div className="ficha-subsection">
                          ...
                          <div className="ficha-grid">
                            {typeof processamentoResultado.dadosConsolidados
                              .fichaConsolidada.materiaisUtilizados ===
                            "object" ? (
                              Object.entries(
                                processamentoResultado.dadosConsolidados
                                  .fichaConsolidada.materiaisUtilizados
                        ...
                        <div className="ficha-subsection">
                          ...
                          <div className="ficha-item">
                            <div className="ficha-item-value">
                              {
                                processamentoResultado.dadosConsolidados
                                  .fichaConsolidada.responsaveisTecnicos
                              }
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="ficha-subsection">
                          ...
                          <div className="ficha-item">
                            <div className="ficha-item-value">
                              {
                                processamentoResultado.dadosConsolidados
                                  .fichaConsolidada.observacoesRelevantes
                              }
                            </div>
                          </div>
                        </div>
          ...
          {processamentoResultado.dadosConsolidados &&
            processamentoResultado.dadosConsolidados.erro && (
              <div className="result-container">
            ...
            <li key={index} className="arquivo-item">
              <div className="arquivo-info">
                <div style={{ display: "flex", gap: "10px" }}>
                  ...
                  <span>
                    Data: {new Date(arquivo.dataUpload).toLocaleString()}
                  </span>
                </div>
                <div
                  style={{ display: "flex", gap: "10px", marginTop: "5px" }}
                  className="arquivos-details"
                >
                  ...
                  <button
                    style={{
                      ...
                      cursor: "pointer",
                      fontWeight: "bold",
                      backgroundColor: "#ffcb5bff",
                    }}
                  >
                    <FiEye></FiEye>Visualizar
                  </button>
                </div>
              </div>
            </li>
    ...
    return (
      <div className="result-container">
        ...
        <div className="button-group">
          {/* 38192073892017321893072189371203987381072312803710893273891071290387129871293087129837128978129302713908 */}
          <button
          ...
          <button
            ...
            style={{ marginLeft: "10px", float: "right" }}
          >
            <FiEdit style={{ marginRight: "5px" }} /> Editar
          </button>
        </div>
        ...
        <div className="ficha-tecnica">
          <div className="ficha-header">
            ...
            <p>
              Data de Processamento:{" "}
              {new Date(ficha.dataProcessamento).toLocaleString()}
            </p>
          </div>
              ...
              <div className="ficha-section">
                  ...
                  <div className="ficha-subsection">
                    ...
                    <div className="ficha-grid">
                      <div className="ficha-item">
                        <div className="ficha-item-label">PAÍS:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.informacoesGerais.pais}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">TIPO DE PROJETO:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.informacoesGerais.tipoProjeto}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">CONTRATANTE:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.informacoesGerais.contratante}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">
                      ...
                      <div className="ficha-item">
                        <div className="ficha-item-label">DURAÇÃO:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.informacoesGerais.duracao}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">OBJETO:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.informacoesGerais.objeto}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="ficha-subsection">
                    ...
                    <div className="ficha-grid">
                      <div className="ficha-item">
                        <div className="ficha-item-label">LATITUDE:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.localizacao.latitude}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">LONGITUDE:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.localizacao.longitude}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">RIO:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.localizacao.rio}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">BACIA:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.localizacao.bacia}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="ficha-subsection">
                    ...
                    <div className="ficha-grid">
                      <div className="ficha-item">
                        <div className="ficha-item-label">TIPO:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.desvio.tipo}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">VAZÃO DE DESVIO:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.desvio.vazaoDesvio}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="ficha-subsection">
                    ...
                    <div className="ficha-grid">
                      <div className="ficha-item">
                        <div className="ficha-item-label">TIPO:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.barragemPrincipal.tipo}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">ALTURA MÁXIMA:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.barragemPrincipal.alturaMaxima}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">COMPRIMENTO:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.barragemPrincipal.comprimento}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">VOLUME:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.barragemPrincipal.volume}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="ficha-subsection">
                    ...
                    <div className="ficha-grid">
                      <div className="ficha-item">
                        <div className="ficha-item-label">TIPO:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.barragensComplementares.tipo}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">
                  ...
                  <div className="ficha-subsection">
                    ...
                    <div className="ficha-grid">
                      <div className="ficha-item">
                        <div className="ficha-item-label">TIPO:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.vertedouro.tipo}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">NÚMERO DE VÃOS:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.vertedouro.numeroVaos}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">
                        ...
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.vertedouro.comprimentoTotal}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">CAPACIDADE:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.vertedouro.capacidade}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">TR:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.vertedouro.tr}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="ficha-subsection">
                    ...
                    <div className="ficha-grid">
                      <div className="ficha-item">
                        <div className="ficha-item-label">TIPO:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.casaForcaPrincipal.tipo}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">
                      ...
                      <div className="ficha-item">
                        ...
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.casaForcaPrincipal.tipoTurbina}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">
                      ...
                      <div className="ficha-item">
                        ...
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.casaForcaPrincipal.rendimento}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">QUEDA BRUTA:</div>
                        <div className="ficha-item-value">
                          {ficha.dadosAnalisados.casaForcaPrincipal.quedaBruta}
                        </div>
                      </div>
                      <div className="ficha-item">
                        <div className="ficha-item-label">
                ...
                {ficha.dadosAnalisados.materiaisUtilizados && (
                  <div className="ficha-subsection">
                    <h5>MATERIAIS UTILIZADOS</h5>
                    <div className="ficha-grid">
                      {typeof ficha.dadosAnalisados.materiaisUtilizados ===
                      "object" ? (
                        Object.entries(
                          ficha.dadosAnalisados.materiaisUtilizados
                        ).map(([material, quantidade]) => (
